...
>
	...
	<div id="content-head">
		...
		<p>Gerado por <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank">All in One SEO</a>, este é um sitemap XML, destinado a ser consumido por motores de busca como Google ou Bing.</p>
		<p>
			Você pode encontrar mais informações sobre sitemaps XML em <a href="https://www.sitemaps.org/" target="_blank" rel="noreferrer noopener">sitemaps.org</a>.		</p>
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				and was generated on 26/10/2023 at 7:17 am			</p>
		</xsl:if>
	</div>
</xsl:template>
